...
public static class DataSeeder
{
    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        var user1 = new ApplicationUser { Id = "DefaultAdmin1", FirstName = "Sexy", LastName = "Sotong", UserName = "nghanyi1997@gmail.com", NormalizedUserName = "nghanyi1997@gmail.com", NormalizedEmail = "nghanyi1997@gmail.com", PhoneNumber = "To Be Changed", Email = "nghanyi1997@gmail.com", TwoFactorEnabled = false, AuthenticationType = "None", SMSExpiry = new DateTime(2022, 7, 19, hour: 12, minute: 00, second: 00), UserFaculty = "SE", AccessFailedCount = 0, LockoutEnabled = true, EmailConfirmed = true, PhoneNumberConfirmed = false, PreferredNotification = NotificationType.EMAIL };
        ...
        modelBuilder.Entity<Lab>().HasData(
            new Lab { LabId = 1, LabLocation = "NYP-SR7A", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 25, EnergyUsageBenchmark = 111.5 },
            new Lab { LabId = 2, LabLocation = "NYP-SR7B", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 30, EnergyUsageBenchmark = 111.5 },
            new Lab { LabId = 3, LabLocation = "NYP-SR7C", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 20, EnergyUsageBenchmark = 111.5 }
        );
